...
export function NoItemsOnList() {
  return (
    <div className="flex flex-col items-center w-full bg-[#fff] gap-4 py-4 px-6 rounded-md">
      ...
      <Button
        className="text-[#fff] bg-[#7F56D9] rounded-md px-3 py-2 text-sm leading-none outline-indigo-600 border py-2.5 px-3.5 flex items-center gap-1 noItemsOnList__button"
